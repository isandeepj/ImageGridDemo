...
class DiskCache {
    lazy var cacheQueue: DispatchQueue = {
        return DispatchQueue(label: "diskcache.ImageGridDemo", attributes: [])
    }()
...
extension FileManager {
 ...
 fileprivate func enumerateContentsOfDirectory(atPath path: String, orderedByProperty property: String, ascending: Bool, usingBlock block: (URL, Int, inout Bool) -> Void ) {
